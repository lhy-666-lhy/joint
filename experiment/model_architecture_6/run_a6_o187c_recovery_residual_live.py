#!/usr/bin/env python3
"""Run corrected live8 for isolated recovery residual versus uniform recovery."""
...
from path_config import (
    ...
    JOINTTRAIN_ARCH6_O187C_RESULT_ROOT,
)
...
def main() -> int:
    ...
    live.RUN_ID = "a6_o187c_recovery_residual_live8_v1"
    live.SCIENTIFIC_SCOPE = (
        "corrected live8 isolated recovery residual versus uniform recovery"
    )
    live.JOINTTRAIN_ARCH6_O126C_RESULT_ROOT = JOINTTRAIN_ARCH6_O187C_RESULT_ROOT
    return live.main()
