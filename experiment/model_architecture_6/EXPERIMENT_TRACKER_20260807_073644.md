...
- **修订日期**：2026-08-07
- **状态**：`GRASP_FACTOR_REVISION_EXECUTING / G065C_SELECTOR_SCOPED_NEGATIVE / A032C_RUNNING / A030C_UPDATED_PRODUCER_FROZEN`
...
- **最新抓取状态（2026-08-07）**：G063/G064证明多mode与multi-IK监督可构造；G065 best-of-8 oracle显著优于G062，但selected top-1退化，故G066阻断并归因为mode scoring失败
...
| `A6-G066C` | M2 | multi-IK realization + outcome-blind planner selector | CAL | MUST | BLOCKED；G065 selector未通过，不得用oracle候选解锁 |
...
| `A6-A033C` | M2 | UPDATED/INITIAL/MIX060/INITIAL+MIX060 consumer utility | TRAIN/CAL | MUST | BLOCKED on A032 and valid selected grasp consumer；G065当前未通过 |
