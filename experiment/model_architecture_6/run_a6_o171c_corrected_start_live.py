#!/usr/bin/env python3
"""Run O127C/O128C under the corrected operation-start command contract."""
...
def main() -> int:
    ...
    live.RUN_ID = "a6_o171c_corrected_start_live8_v1"
    live.SCIENTIFIC_SCOPE = (
        "corrected operation-start command exact-paired A5_CAL live screen"
    )
    live.JOINTTRAIN_ARCH6_O126C_RESULT_ROOT = JOINTTRAIN_ARCH6_O171C_RESULT_ROOT
    return live.main()
