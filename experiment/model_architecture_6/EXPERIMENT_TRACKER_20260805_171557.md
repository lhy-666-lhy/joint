...
| A6-O010R | corrected memorization | O-MLP-ABS + shared A6-INPUT-v1.1 encoder | fixed 64 chunks | hidden256/dropout0.1；AdamW 1e-4/1e-6；effective batch64；normalized L1；2k；same gate | MUST | O000BR2 | RUNNING | 当前唯一GPU授权；section14.1 bounded pilot + single-GPU fit；同时报告repeat-last与train-mean baselines |
...
`A6-INPUT-v1.1` is applied and O000BR2 passed direct artifact review: exact fixed64 shapes, all finite, contact zero+availability contract, qvel lineage and forbidden audit all pass. O000B/O000BR remain implementation failures only. Corrected O010R is the sole READY GPU run; O020R/O030R remain blocked until O010R provides terminal shared-runner/fit evidence. A000/A010 remain blocked independently. Do not launch DYN64 model fit, physics, heldout evaluation, or conditional complexity.
