...
| A6-O020R | corrected memorization | O-PAR-ABS + shared A6-INPUT-v1.1 encoder | same fixed 64 chunks | same hidden256/dropout0.1/AdamW/L1/seed/batch/2k gate；parallel learned queries | MUST | O000BR2,O010R terminal | RUNNING | 当前唯一GPU授权；独立单卡bounded pilot + fit；总参数较O010R +4.03%，decoder +5.44% |
...
O010R is a valid scoped training-fit failure: final normalized MAE 0.025114, 26.94x decrease, and 142% worse than repeat-last, with finite gradients, exact reload, clean lineage/audit and valid resource pilot. It rejects only the frozen O-MLP-ABS fixed64 arm. Corrected O020R is the sole READY GPU run; O030R remains blocked until O020R terminal evidence. A000/A010 remain blocked independently. Do not launch DYN64 model fit, physics, heldout evaluation, or conditional complexity.
