...
- **修订日期**：2026-08-07
- **状态**：`OPERATION_CANDIDATE_FROZEN / A030C_PRED_AFFORDANCE_POSITIVE / G062C_SCOPED_NEGATIVE / ITERATION_BUDGET_COMPLETE`
- **权威计划**：`EXPERIMENT_PLAN.md`
- **当前训练状态**：无训练进程；三轮iteration已完成；G062未通过paired CI gate，不启动IK/physical
- **最新抓取状态（2026-08-07）**：A030/G061 contact proposal机制为正；G062 shared contact-conditioned SE3 scoped negative；不启动IK/physical
