...
| A6-O010S | revised-budget memorization | O-MLP-ABS scratch under A6-FIT-v1.2 | same fixed64 | 6k；2k reproduction；MAE<=1e-3；100x；reload<=1e-6；same scientific config | MUST | O000C + revision | RUNNING | 当前唯一GPU授权；复用O010R pilot microbatch64；scratch 2k parity + fixed 6k gate |
| A6-O020S | revised-budget memorization | O-PAR-ABS scratch under A6-FIT-v1.2 | same fixed64 | same 6k/reproduction/gates | MUST | O010S terminal | BLOCKED | 独立分支，不因O010S failure取消 |
| A6-O030S | revised-budget memorization | O-CAUSAL-ABS scratch under A6-FIT-v1.2 | same fixed64 | same 6k/reproduction/gates；TF train/AR eval | MUST | O020S terminal | BLOCKED | 独立分支；额外报告TF/AR gap |
...
O000C passed: all encoder embeddings are unique/rank63, all three 2k models trail repeat-last, and causal teacher-forced 0.007464 vs autoregressive 0.117343 confirms a 15.72x exposure gap. Revision A6-FIT-v1.2 aligns fixed64 sanity to the already-frozen 6k formal budget without changing model/data/seed/dropout/optimizer/loss/effective batch/gates. O010S is the sole READY GPU run; O020S/O030S remain sequentially blocked but independent. DYN64, physics, heldout evaluation and conditional complexity remain blocked.
