#!/usr/bin/env python3
"""Run the decisive fresh-world fixed-budget operation comparison."""
...
from path_config import (
    ...
    JOINTTRAIN_ARCH6_O193C_RESULT_ROOT,
)
...
def main() -> int:
    ...
    live.RUN_ID = "a6_o193c_fresh_world_fixed_budget_live8_v1"
    live.SCIENTIFIC_SCOPE = (
        "fresh-world fixed 5200-physics-step operation policy comparison"
    )
    live.JOINTTRAIN_ARCH6_O126C_RESULT_ROOT = JOINTTRAIN_ARCH6_O193C_RESULT_ROOT
    return live.main()
