...
| A6-O020S | revised-budget memorization | O-PAR-ABS scratch under A6-FIT-v1.2 | same fixed64 | same 6k/reproduction/gates | MUST | O010S terminal | RUNNING | 当前唯一GPU授权；复用O020R pilot microbatch64；scratch 2k parity + fixed 6k gate |
...
O010S exactly reproduces O010R at 2k, then reaches 0.014016/48.27x at 6k but remains 35.1% worse than repeat-last; it is a valid final scoped MLP training-fit negative under A6-FIT-v1.2. O020S is the sole READY GPU run; O030S remains blocked but independent. DYN64, physics, heldout evaluation and conditional complexity remain blocked.
