...
| A6-O030S | revised-budget memorization | O-CAUSAL-ABS scratch under A6-FIT-v1.2 | same fixed64 | same 6k/reproduction/gates；TF train/AR eval | MUST | O020S terminal | REJECTED | 2k parity error0；6k AR0.056632/15.13x，TF0.003322，AR/TF17.05x；valid scoped negative |
| A6-O000D | revised-budget M1 review | aggregate R/S histories, gates and O000C | fixed64 artifacts only | 2k->6k slope；repeat gap；TF/AR；representation route；zero training/replay | MUST | O010S/O020S/O030S terminal | RUNNING | CPU-only metadata review；判断是否提前O200 start-delta；DYN64仍锁定 |
...
All A6-FIT-v1.2 ABS arms exactly reproduce 2k and fail at 6k: MLP 0.014016, PAR 0.028086, causal AR 0.056632 vs repeat 0.010378. Causal TF is 0.003322 but AR/TF remains 17.05x. O000D is the sole READY CPU review; no DYN64 or representation change before its evidence and a new revision if required. Physics, heldout and conditional complexity remain blocked.
